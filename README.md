...
| Seniors readmitted per year | 2.6 million |
| Annual Medicare cost | $26 billion+ |
| Participating CCTP sites | 18 |
...
Community-Based Organizations (CBOs) — or acute care hospitals partnered with CBOs — applied to deliver care transition interventions. CBOs were paid an **all-inclusive rate per eligible discharge**, and only once per beneficiary per **180-day period**.

### CBO Eligibility Criteria

- Physically located in the community being served
- Legal entity capable of accepting payment
- Formal agreements with acute care hospitals
- Governing body with multi-stakeholder representation including consumers
...
The dominant model was **Dr. Eric Coleman's CTI** — a 30-day structured coaching program where a **Transitions Coach®** works with patients and family caregivers across four key pillars:

### The Four Pillars®

| Pillar | Description |
|---|---|
| 💊 Medication management | Understanding and safely managing prescriptions post-discharge |
| 📅 Follow-up visits | Timely physician appointments after leaving the hospital |
| 📋 Personal health record | Patient-owned record enabling informed self-advocacy |
| ⚠️ Warning signs | Recognizing symptoms that signal a need for urgent care |
...
- ✅ 30-day readmission rate of **2.4%** in coached cohort vs **23.8%** in control group *(Coleman et al., 2004)*.
...
| Program | Description |
|---|---|
| **ADRC Evidence-Based Care Transitions** | ACL/CMS program awarding 16 states funding to implement six evidence-based models (2010) |
